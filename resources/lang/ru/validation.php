...
return [
    ...
    */
    ...
    'required_image_on_update' => 'Поле Изображение обязательно для заполнения.',
    'phone_unique' => 'Такое значение поля :attribute уже существует.',
    'no_letters' => 'Поле не может содержать символы :attribute.',
    'passport_unique' => 'Такой паспорт уже существует',
    'identity_unique' => 'Такая ID-карта уже существует',
    'strong_password' => 'Пароль должен содержать большие и маленькие латинские буквы, цифры, и спец-символы',
    'strong_borrower_password' => 'Пароль должен содержать латинские буквы и цифры',
    'only_one_field_in_info' => 'Должно быть заполнен только один тип',
    'contacts_unique' => 'Номер телефона должен быть уникальным',
    'contacts_exists' => 'Номер телефона должен быть уникальным',
    'contacts_self_phone' => 'Номер телефона не должен совпадать с вашим номером',
    'passport_date' => 'Дата должна быть больше 16 лет от даты рождения',
    'update_exists'        => 'Выбранное значение для :attribute некорректно.',
